...
const navigation = [
  ...
  { name: 'Add Item', href: '/add-item', icon: QrCodeIcon },
  { name: 'Waste Tracking', href: '/waste-tracking', icon: ChartPieIcon },
              ...
              <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-primary-600 px-6 pb-4">
                  <div className="flex h-16 shrink-0 items-center">
                    <h1 className="text-2xl font-bold text-white">WasteNot</h1>
                  </div>
